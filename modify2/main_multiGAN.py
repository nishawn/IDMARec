...
from models import SASRecModel, SASRecAttributeModel, SASRecUserItemPromptModel, SASRecUserPropmtModel,OfflineItemSimilarity, OnlineItemSimilarity
...
def main():
    ...
    # CLGAN args
    parser.add_argument("--CLGAN_weight", type=float, default=0.55)
    ...
    args.log_file = os.path.join(args.output_dir, args_str + "testMultiGAN-warm.txt")
    ...
    generator_C = SASRecUserPropmtModel(args=args)
    ...
    # args = update_to_module_parameters(args, m_type='gen')
    # generator_A = SASRecUserItemPromptModel(args=args)
    # generator_B = SASRecAttributeModel(args=args)
    # generator_C = SASRecUserPropmtModel(args=args)
    # args = update_to_module_parameters(args, m_type='dis')
    # discriminator_A = SASRecModel(args=args)
    ...
    # generator_C = SASRecUserPropmtModel(args=args)
    # args = update_to_module_parameters(args, m_type='dis')
    # discriminator_A = SASRecUserItemPromptModel(args=args)
    # discriminator_B = SASRecAttributeModel(args=args)
    # discriminator_C = SASRecUserPropmtModel(args=args)
    # args = update_to_module_parameters(args, m_type='gen')
    # generator_A = SASRecUserItemPromptModel(args=args)
    # generator_B = SASRecAttributeModel(args=args)
    # generator_C = SASRecUserPropmtModel(args=args)
    ...
    if args.model_shared_type == 'embed_only':
        ...
        generator_C.item_embeddings = generator_B.item_embeddings
        generator_C.position_embeddings = generator_B.position_embeddings
        ...
        generator_C.item_encoder = generator_B.item_encoder
    ...
    trainer = ICLRecTrainer(generator_A, generator_B, generator_C,
                                discriminator_A, discriminator_B, discriminator_C,
