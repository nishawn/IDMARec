...
def main():
    ...
    parser.add_argument('--data_name', default='taobao', type=str)
    ...
    parser.add_argument("--gen_num_hidden_layers", type=int, default=3, help="number of layers")
    parser.add_argument('--gen_num_attention_heads', default=4, type=int)
    ...
    parser.add_argument("--dis_num_hidden_layers", type=int, default=3, help="number of layers")
    parser.add_argument('--dis_num_attention_heads', default=4, type=int)
    ...
    trainer = ELECITY(model, train_dataloader, \
                      eval_dataloader, test_dataloader, args)
