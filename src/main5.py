...
#
# from train_intent1 import ELECITY
...
#     args.log_file = os.path.join(args.output_dir, args_str + 'sample_hp.txt')
#
#     show_args_info(args)
#
...
def main():
    ...
    # save model args
    args_str = f'{args.model_name}-{args.data_name}-{args.model_idx}'
    args.log_file = os.path.join(args.output_dir, args_str + 'sample-etc-hp2.txt')
