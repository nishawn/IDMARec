...
from train_GAN import ELECITY
from models import SASRecModel, SASRecUserPropmtModel, SASRecAttributeModel
...
def main():
    ...
    parser.add_argument("--dis_loss_weight", type=float, default=0.6)
    ...
    args.log_file = os.path.join(args.output_dir, args_str + 'withoutCGAN.txt')
    ...
    trainer = ELECITY(generator_A,  discriminator_A,  train_dataloader, cluster_dataloader,
                      eval_dataloader, test_dataloader, args)
